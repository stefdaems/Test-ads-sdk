import UIKit
    ...
    /// Bitmovin Player host view controller for Ads SDK integration testing.
    ///
    ...
    class ViewController: UIViewController {
        ...
        override func viewDidLoad() {
            ...
            setupUI()
            // TODO: Initialise Bitmovin here
            // TODO: Call AdsSDK.initialize(publisherId: "YOUR_PID", player: bitmovinPlayer, playerType: .bitmovin)
            log("sdk_initialized")
            log("adapter_attached:bitmovin")
        }
