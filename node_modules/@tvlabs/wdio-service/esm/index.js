...
class TVLabsService {
    ...
    static fromSession(appiumSessionId, options, wdOpts) {
        if (!wdOpts.capabilities ||
            ...
            throw new SevereServiceError('wdOpts.capabilities must be a capabilities object. Multi-remote capabilities are not supported.');
        }
    ...
    async beforeSession(_config, capabilities, _specs, _cid) {
        if (this._rehydratedSessionId) {
            throw new SevereServiceError('beforeSession() is not valid on a rehydrated service. The session was supplied to fromSession() and should not be recreated.');
        }
        try {
